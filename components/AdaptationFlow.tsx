...
const ALL_LOCALES: Locale[] = [
  ...
  },
  {
    ...
    segments: [
      ...
      { hl: 'kiondo', b: 4 },
      ' bumped against her hip as she ran past ',
      { hl: 'Holy Family Basilica', b: 1 },
      '. The street smelled of wet earth and roasting maize from ',
      { hl: "Otieno's", b: 0 },
      ' cart. She cut through the alley between ',
      { hl: "Njoroge's tailor shop", b: 0 },
      ' and the old printing press. ',
      { hl: 'Cucu Nyambura', b: 3 },
  ...
  },
  {
    ...
    segments: [
      ...
      '이 뛸 때마다 엉덩이를 탁탁 쳤다. ',
      { hl: '성당', b: 1 },
      ' 앞을 지나 달리는데, 거리에서 젖은 아스팔트와 ',
      { hl: '정씨 아저씨', b: 0 },
      ' 포장마차의 떡볶이 냄새가 났다. ',
      { hl: '박 재봉사', b: 0 },
      ' 가게와 오래된 인쇄소 사이 골목을 지름길로 빠졌다. ',
      { hl: '할머니', b: 3 },
      '는 분명 ',
      { hl: '현관 앞', b: 1 },
