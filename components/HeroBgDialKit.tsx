...
export function useHeroBgConfig() {
  ...
  return { radiusRef, ui, setCity, setRadius, reset };
}
...
export function HeroBgDialKit({ ui, setCity, setRadius, reset }: Props) {
      ...
      {open && (
        <div style={{
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    padding: '7px 10px',
                    borderRadius: 6,
                    border: active ? '1.5px solid var(--scarlet)' : '1.5px solid var(--vellum-shade-1)',
                ...
                >
                  ...
                  <span>{label}</span>
                  {active && (
                    <span style={{ marginLeft: 'auto', fontSize: 10, color: 'var(--scarlet)' }}>●</span>
                  )}
                </button>
              );
            })}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: '4px 8px', alignItems: 'center', marginBottom: 10 }}>
            ...
            <input
              type="range" min={80} max={500} step={10} value={ui.cursorRadius}
